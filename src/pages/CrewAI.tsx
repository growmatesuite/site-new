          ...
          <Container className="relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center bg-[#ff5a50] hover:bg-[#ff7a6a] text-black font-semibold rounded-lg px-8 py-3 transition-colors">
