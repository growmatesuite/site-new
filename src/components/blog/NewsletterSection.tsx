                            ...
                            {status === 'success' ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <p className="text-center text-xs text-gray-600">
                                        Ao se inscrever, você concorda com nossa <a href="/privacy" target="_blank" rel="noopener noreferrer" className="underline hover:text-green-primary transition-colors">Política de Privacidade</a>.
                                    </p>
                                </form>
                            )}
                        </div>
