      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="relative py-32 overflow-hidden">
          ...
          <Container size="lg" className="relative z-10">
            <div className="mb-8 flex justify-center">
              <Breadcrumbs items={[{ label: 'Soluções', href: '/solucoes' }, { label: 'GrowChat' }]} />
            </div>
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-heading font-bold mb-6">
                ...
                <span className="text-whatsapp-ufo"> WhatsApp</span> da sua empresa
              </h1>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer">
                  <Button variant="whatsapp" size="lg" className="text-black-base bg-whatsapp-ufo hover:bg-whatsapp-dark">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  <Shield className="h-4 w-4 text-whatsapp-ufo" />
                  <span>LGPD Compliance</span>
                </div>
                <div className="flex items-center gap-2">
                  <Target className="h-4 w-4 text-whatsapp-ufo" />
                  <span>Controle Total dos Dados</span>
                </div>
                <div className="flex items-center gap-2">
                  <MessageCircle className="h-4 w-4 text-whatsapp-ufo" />
          ...
          <Container size="lg">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
                A <span className="text-whatsapp-ufo">solução completa</span> para profissionalizar o relacionamento
          ...
          <Container size="lg">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
                Organização <span className="text-whatsapp-ufo">Imediata</span>
              </h2>
                  ...
                  <Card glowColor="whatsapp" hoverable className="h-full">
                    <div className="p-6">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="p-2 bg-whatsapp-dark/40 rounded-lg text-whatsapp-ufo">
                          {feature.icon}
                        </div>
        ...
        <section className="py-20 bg-gradient-to-r from-whatsapp-dark/20 to-whatsapp-primary/10">
          <Container size="lg">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
                CRM <span className="text-whatsapp-ufo">Leve Integrado</span>
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div
                ...
                className="text-center"
              >
                <div className="w-16 h-16 bg-whatsapp-dark/40 rounded-full flex items-center justify-center mx-auto mb-4 text-whatsapp-ufo">
        ...
        <section className="py-20">
          <Container size="lg">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
                Vendedor <span className="text-whatsapp-ufo">24/7</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <Card glowColor="whatsapp" className="p-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-whatsapp-ufo mt-1 flex-shrink-0" />
                      <div>
              ...
              >
                <div className="relative">
                  <div className="absolute inset-0 bg-whatsapp-ufo/20 blur-3xl rounded-full"></div>
                  <Brain className="h-32 w-32 text-whatsapp-ufo mx-auto relative z-10" />
                </div>

                <div className="mt-8 space-y-4">
                  <div className="text-3xl font-bold text-whatsapp-ufo">+2M</div>
                  <div className="text-gray-300">mensagens/mês</div>

                  <div className="text-3xl font-bold text-whatsapp-ufo">95%</div>
        ...
        <section className="py-20 bg-black-secondary/30">
          <Container size="lg">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
                Como <span className="text-whatsapp-ufo">Funciona</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                    ...
                    <div className="flex-1">
                      <Card glowColor="whatsapp" className="p-6">
                        <div className="flex items-start gap-4">
                          <div className="flex-shrink-0 w-12 h-12 bg-whatsapp-dark/40 rounded-full flex items-center justify-center text-whatsapp-ufo text-lg font-bold">
                            {step.step}
                          </div>
                          <div className="flex-1">
                          ...
                          <div className="text-whatsapp-ufo">{step.icon}</div>
                        </div>
                      </Card>
                    </div>
                    <div className="flex-shrink-0">
                      <div className="w-px h-16 bg-gradient-to-b from-whatsapp-ufo/50 to-transparent"></div>
                    </div>
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-6 mt-6 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  <Clock className="h-4 w-4 text-whatsapp-ufo" />
                  <span>Setup em 2 dias</span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="h-4 w-4 text-whatsapp-ufo" />
        ...
        <section className="py-20">
          <Container size="lg">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
                Recursos <span className="text-whatsapp-ufo">Completos</span>
              </h2>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              >
                <Card glowColor="whatsapp" className="p-8 h-full">
                  <h3 className="text-xl font-semibold mb-4 flex items-center gap-3">
                    <Zap className="h-6 w-6 text-whatsapp-ufo" />
              ...
              >
                <Card glowColor="whatsapp" className="p-8 h-full">
                  <h3 className="text-xl font-semibold mb-4 flex items-center gap-3">
                    <MessageCircle className="h-6 w-6 text-whatsapp-ufo" />
                    Omnichannel
                  </h3>
                  <p className="text-gray-300">
            ...
            >
              <Card glowColor="whatsapp" className="p-8">
                <h3 className="text-xl font-semibold mb-4 flex items-center gap-3">
                  <Smartphone className="h-6 w-6 text-whatsapp-ufo" />
                  Aplicativo Mobile
                </h3>
                <p className="text-gray-300">
        ...
        <section className="py-20 bg-black-secondary/30">
          <Container size="lg">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
                Perguntas <span className="text-whatsapp-ufo">Frequentes</span>
              </h2>
            </motion.div>
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  <Card glowColor="whatsapp" className="p-6 h-full">
                    <h3 className="text-lg font-semibold mb-3 text-whatsapp-ufo">
                      {faq.question}
                    </h3>
          ...
          <Container size="lg">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6">
                Pronto para ter seu <span className="text-whatsapp-ufo">WhatsApp sob controle?</span>
              </h2>
              ...
              <div className="text-center text-sm text-gray-400">
                <div className="mb-2">
                  <span className="text-whatsapp-ufo font-medium">IA sob medida</span> +2M mensagens/mês. <span className="text-whatsapp-ufo font-medium">95% satisfação</span>
                </div>
              </div>
            </motion.div>
          </Container>
